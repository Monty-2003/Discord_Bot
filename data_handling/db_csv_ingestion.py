...
def main():
    # Get .csv file data
    trail_data = pd.read_csv("./data_handling/csv_data/City_Trails.csv")
    park_data = pd.read_csv("./data_handling/csv_data/Park_Area.csv")
    bus_stop_data = pd.read_csv("./data_handling/csv_data/CAT_Bus_Stop_Points.csv")
    bike_rack_data = pd.read_csv("./data_handling/csv_data/Bicycle_Rack_Points.csv")
